...
void nRF24L01_init(nRF24L01* chip, uint32_t nodeId, const uint8_t* txAddr, uint8_t rxmode)
{
	...
	// the payload wide of the pipes, demo=0x00//设置接收数据长度，本次设置为32字节
...
// ---------------------------------------------------------------------------
// nRF24L01 SPI read/write utility func
// ---------------------------------------------------------------------------
static uint8_t SPI_RW(SPI_TypeDef* spi, uint8_t data)
{
...
// ---------------------------------------------------------------------------
/// 函数：uchar nRF24L01_readReg(uchar reg)
/// 功能：NRF24L01的SPI时序
// ---------------------------------------------------------------------------
uint8_t nRF24L01_readReg(nRF24L01* chip, uint8_t reg)
{
...
// ---------------------------------------------------------------------------
// 函数：void nRF24L01_TxPacket(uint8_t * bufTX)
// 功能：发送 tx_buf中数据
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// 函数：uint8_t nRF24L01_RxPacket(uint8_t* bufRX)
