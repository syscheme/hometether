...
__IO__ SD_Error TransferError = SD_OK;
__IO__ uint32_t TransferEnd = 0;
__IO__ uint32_t NumberOfBytes = 0;
...
static SD_Error FindSCR(u16 rca, uint32_t *pscr);
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_ReadBlock(uint32_t addr, uint32_t *readbuff, u16 BlockSize)
{
	SD_Error errorstatus = SD_OK;
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_ReadMultiBlocks(uint32_t addr, uint32_t *readbuff, u16 BlockSize, uint32_t NumberOfBlocks)
{
	SD_Error errorstatus = SD_OK;
	uint32_t count = 0, *tempbuff = readbuff;
	uint8_t power = 0;
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_WriteBlock(uint32_t addr, uint32_t *writebuff, u16 BlockSize)
{
	SD_Error errorstatus = SD_OK;
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_WriteMultiBlocks(uint32_t addr, uint32_t *writebuff, u16 BlockSize, uint32_t NumberOfBlocks)
{
	SD_Error errorstatus = SD_OK;
	uint8_t  power = 0, cardstate = 0;
...
{
	SD_Error errorstatus = SD_OK;
	__IO__ uint32_t respR1 = 0, status = 0;
