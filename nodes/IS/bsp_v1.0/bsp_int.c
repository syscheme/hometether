...
void ISR_nRF24L01 (void)
{
	...
	{
		GPIO_WriteBit(GPIOA, GPIO_Pin_2, (BitAction) 0); // turn on LED
		
		processIRQ_nRF24L01(&nrf24l01);
		EXTI_ClearITPendingBit(EXTI_Line8);
		
//		delayXusec(20000);
		GPIO_WriteBit(GPIOA, GPIO_Pin_2, (BitAction) 1); // turn off LED
	}
}
...
void  BSP_IntInit (void)
{
	...
	BSP_IntVectSet(BSP_INT_ID_EXTI9_5, ISR_nRF24L01);
}
