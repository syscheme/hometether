...
#define CONST_STR_LEN(_STR)            (sizeof(#_STR)-1)
#define CONST_STR_AND_LEN(_STR) #_STR, CONST_STR_LEN(_STR)
...
uint32_t data1=0x12345678, data2=0x87654321;

USR_OD_DECLARE_START()
  OD_DECLARE(data1,  ODTID_BYTES, ODF_Readable|ODF_Writeable, &data1, sizeof(data1))
  OD_DECLARE(data2,  ODTID_BYTES, ODF_Readable|ODF_Writeable, &data2, sizeof(data2))
USR_OD_DECLARE_END()
