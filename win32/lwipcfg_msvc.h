...
/* #define USE_PCAPIF 1 */
#define LWIP_PORT_INIT_IPADDR(addr)   IP4_ADDR((addr), 192,168,81,3)
#define LWIP_PORT_INIT_GW(addr)       IP4_ADDR((addr), 192,168,81,126)
#define LWIP_PORT_INIT_NETMASK(addr)  IP4_ADDR((addr), 255,255,255,128)
